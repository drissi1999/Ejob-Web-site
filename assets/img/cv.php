		...
		<div class="page-title"  style="background-color:#007bff!important;">
          <div class="layout-2">
            <div class="layout-2-item layout-2-item-main" >
              <!-- Profile Light-->
<article class="profile-light"><img class="profile-light-image" <?php if($photo==NULL){ ?>src="assets/img/user-default.jpg" <?php }else{?> src="assets/photo/<?php echo $photo; }?>" alt="">
